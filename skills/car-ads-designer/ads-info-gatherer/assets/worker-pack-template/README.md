...
The gatherer should read this folder, validate it, and normalize it into the standard source-pack outputs in `artifacts/car-ads-designer/ads-info-gatherer/<task-id>/`.
